...
export DATASETS_OVERRIDE="medqa_usmle"
export OUT_ROOT="${OUT_ROOT:-$VERL_ROOT/outputs/prompt_check_textbooks_medqa}"

export TOTAL_TRAINING_STEPS="${TOTAL_TRAINING_STEPS:-3}"
export TOTAL_EPOCHS="${TOTAL_EPOCHS:-1}"
export SAVE_FREQ="${SAVE_FREQ:-999999}"
export TEST_FREQ="${TEST_FREQ:-999999}"
...
export PROJECT_NAME="${PROJECT_NAME:-verl_biomed_search_lora_prompt_check}"

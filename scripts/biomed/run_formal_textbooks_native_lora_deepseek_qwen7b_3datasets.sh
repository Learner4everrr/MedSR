...
export MODEL_TAG="${MODEL_TAG:-deepseek_r1_qwen_7b}"
export MODEL_PATH="${MODEL_PATH:-deepseek-ai/DeepSeek-R1-Distill-Qwen-7B}"
export OUT_ROOT="${OUT_ROOT:-$VERL_ROOT/outputs/formal_textbooks_native_lora_deepseek_qwen7b_500step_promptfix}"

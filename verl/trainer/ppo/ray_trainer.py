            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    if self.config.trainer.critic_warmup > self.global_steps:
                        ...
                        # update weights from trainer to rollout before checkpointing
                        # so the checkpoint save does not leave a high-memory sync
                        # immediately afterward. Validation below then uses current weights.
